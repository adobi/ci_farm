...
-- ----------------------------
INSERT INTO `chicken_stock` VALUES ('5', '202228', '', '14', '2009-07-09 00:00:00', '420', '176', '11', 'III', '420', '11', '2500', '11', 'kelés', '202228', '202112', null, 'F 39', '2010-10-10 00:00:00', '2009-07-09 00:00:00', '1', null);
INSERT INTO `chicken_stock` VALUES ('6', '202112', '', '14', '2009-07-09 00:00:00', '2500', '', '0', '', '0', '0', '0', '0', '', '', '', null, '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '1', null);
INSERT INTO `chicken_stock` VALUES ('7', '202211', '', '14', '2009-07-09 00:00:00', '500', '176', '14', 'III', '0', '0', '500', '14', 'kelés', '', '202211', null, 'AC 39', '2010-10-31 00:00:00', '2009-07-09 00:00:00', '1', null);
INSERT INTO `chicken_stock` VALUES ('9', '202198', '', '14', '2009-07-09 00:00:00', '1140', '176', '10', 'III', '0', '0', '1140', '10', 'kelés', '', '202198', null, 'R 39', '2010-10-31 00:00:00', '2009-07-09 00:00:00', '1', null);
...
-- ----------------------------
-- Table structure for `chicken_stock_copy`
-- ----------------------------
DROP TABLE IF EXISTS `chicken_stock_copy`;
CREATE TABLE `chicken_stock_copy` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `stock_code` varchar(45) DEFAULT NULL,
  `intra_code` varchar(45) DEFAULT NULL,
  `hatching_breeder_site_id` int(11) DEFAULT NULL,
  ...
  KEY `fk_chicken_stock_female_cast_type` (`female_cast_type`),
  KEY `fk_chicken_stock_holder_breeder_site` (`holder_breeder_site_id`),
  CONSTRAINT `chicken_stock_copy_ibfk_1` FOREIGN KEY (`cast_type_id`) REFERENCES `cast_type` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `chicken_stock_copy_ibfk_2` FOREIGN KEY (`delivery_id`) REFERENCES `delivery` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `chicken_stock_copy_ibfk_3` FOREIGN KEY (`female_cast_type`) REFERENCES `cast_type` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `chicken_stock_copy_ibfk_4` FOREIGN KEY (`hatching_breeder_site_id`) REFERENCES `breeder_site` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `chicken_stock_copy_ibfk_5` FOREIGN KEY (`holder_breeder_site_id`) REFERENCES `breeder_site` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `chicken_stock_copy_ibfk_6` FOREIGN KEY (`male_cast_type`) REFERENCES `cast_type` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of chicken_stock_copy
-- ----------------------------
...
-- Records of delivery
-- ----------------------------
INSERT INTO `delivery` VALUES ('1', '11729718', '10', '1', '1', '139771', '14', '2009-07-09 00:00:00', '4560', '8', '', '', '', 'KUM106', '0000-00-00 00:00:00', '8', '2009-07-09 00:00:00', '4560', '2009-07-09 00:00:00', null);

...
CREATE TABLE `egg_stock` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_buyer_breeder_site` (`buyer_breeder_site_id`),
  KEY `fk_egg_stock_egg_type` (`egg_type_id`),
  CONSTRAINT `fk_buyer_breeder_site0` FOREIGN KEY (`buyer_breeder_site_id`) REFERENCES `breeder_site` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_egg_stock_egg_type` FOREIGN KEY (`egg_type_id`) REFERENCES `egg_type` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of egg_stock
-- ----------------------------
INSERT INTO `egg_stock` VALUES ('1', '112233', '2011-07-01 00:00:00', 'V', '123', '(5c.2c.4n.7n) INTRA.FR.2009.0055972', '124', '(5c.2c.4n.7n) INTRA.FR.2009.0055972', '0', '0', 'a 3', '2011-07-31 00:00:00', null, '3', '14', '1300');
INSERT INTO `egg_stock` VALUES ('2', '334455', '2011-07-05 00:00:00', 'III', '123', '(5c.2c.4n.7n) INTRA.FR.2009.0055972', '126', '(5c.2c.4n.7n) INTRA.FR.2009.0055972', null, null, 'c 1', '2011-07-29 00:00:00', null, '3', '8', '1250');
INSERT INTO `egg_stock` VALUES ('3', '667788', '2011-07-07 00:00:00', 'IV', '127', '(5c.2c.4n.7n) INTRA.FR.2009.0055972', '129', '(5c.2c.4n.7n) INTRA.FR.2009.0055972', null, null, 'd 3', '2011-09-30 00:00:00', null, '3', '6', '180');
...
-- ----------------------------
INSERT INTO `hatching_data` VALUES ('3', '1200', '200', '300', '123', '10', '', '1', '2011-07-01 00:00:00', '1');
...
CREATE TABLE `machine` (
  ...
  CONSTRAINT `fk_machine_breeder_site` FOREIGN KEY (`breeder_site_id`) REFERENCES `breeder_site` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of machine
-- ----------------------------
INSERT INTO `machine` VALUES ('1', 'keltető 1', '19982', '3');
INSERT INTO `machine` VALUES ('2', 'keltető 2', '27727', '3');

...
-- Records of cast
-- ----------------------------
INSERT INTO `cast` VALUES ('1', 'Házityúk', '1');
...
CREATE TABLE `egg_type` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_cast_egg_type` (`cast_id`),
  CONSTRAINT `fk_cast_egg_type` FOREIGN KEY (`cast_id`) REFERENCES `cast` (`id`) ON DELETE SET NULL ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of egg_type
-- ----------------------------
INSERT INTO `egg_type` VALUES ('15', '123', 'kicsi', '10', null, '1', '1');
INSERT INTO `egg_type` VALUES ('16', '1000', 'termelői', '10', null, '2', '1');
INSERT INTO `egg_type` VALUES ('17', '111', 'nagy', '0', null, '1', '1');
INSERT INTO `egg_type` VALUES ('18', '1', 'alma', '10', '1', '1', '1');

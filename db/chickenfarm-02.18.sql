...
CREATE TABLE `education` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `hatching_id` int(11) DEFAULT NULL,
  `created` datetime DEFAULT NULL,
  `closed` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_education_hutching` (`hatching_id`),
  CONSTRAINT `fk_education_hutching` FOREIGN KEY (`hatching_id`) REFERENCES `hutching` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of education
-- ----------------------------
INSERT INTO `education` VALUES ('2', '9', '2012-02-18 00:00:00', null);
...
CREATE TABLE `fakk` (
  ...
  `closed` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_fakk_hutching` (`hutching_id`),
  CONSTRAINT `fk_fakk_hutching` FOREIGN KEY (`hutching_id`) REFERENCES `hutching` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of fakk
-- ----------------------------
INSERT INTO `fakk` VALUES ('3', 'doge_3_fakk_1', '9', '2012-02-18 10:50:03', null);
INSERT INTO `fakk` VALUES ('4', 'doge_3_fakk_2', '9', '2012-02-18 10:50:03', null);
...
-- Records of hutching
-- ----------------------------
INSERT INTO `hutching` VALUES ('9', '7', '8', '2012-02-18 10:49:25', '2012-02-18 00:00:00', '1');
...
CREATE TABLE `stock_in_fakk` (
  ...
  `closed` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_sif_fakk` (`fakk_id`),
  KEY `fk_sif_stock` (`stock_id`),
  CONSTRAINT `fk_sif_fakk` FOREIGN KEY (`fakk_id`) REFERENCES `fakk` (`id`),
  CONSTRAINT `fk_sif_stock` FOREIGN KEY (`stock_id`) REFERENCES `chicken_stock` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of stock_in_fakk
-- ----------------------------
INSERT INTO `stock_in_fakk` VALUES ('7', '3', '17', '420', '2009-07-09 00:00:00', null);
INSERT INTO `stock_in_fakk` VALUES ('8', '4', '19', '500', '2009-07-09 00:00:00', null);
INSERT INTO `stock_in_fakk` VALUES ('9', '3', '20', '700', '2009-07-09 00:00:00', null);
INSERT INTO `stock_in_fakk` VALUES ('10', '4', '20', '440', '2009-07-09 00:00:00', null);
